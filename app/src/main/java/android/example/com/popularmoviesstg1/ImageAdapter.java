...
public class ImageAdapter extends ArrayAdapter<GridMovieItem> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        GridMovieItem gridMovieItem=(GridMovieItem) getItem(position);





            Picasso.with(getContext()).load(BASE_URL.concat(gridMovieItem.getPoster_path())).into(imageView_item);
